...
class TestGenerals(unittest.TestCase):
    ...
    instance = Montmorillonite(x = 0, y = 0, inclination = 0, 
                               thickness = 2, length = 100)
    
    def test_particle_number(self):
        n1 = instance.num
        new_instance1 = Montmorillonite(x = 100, y = 100, inclination = 0, 
                               thickness = 2, length = 100)
        n2 = new_instance1.num
        del new_instance
        new_instance2 = Montmorillonite(x = 100, y = 100, inclination = 0, 
                               thickness = 2, length = 100)
