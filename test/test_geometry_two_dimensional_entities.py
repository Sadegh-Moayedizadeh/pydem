...
import unittest
from exceptions import BadEntries
from pydem.geometry import two_dimensional_entities as td
import numpy as np
...
class TestRectangle(unittest.TestCase):
    ...
    def test_from_midline(self):
        ...
        instance = td.Rectangle.from_midline(
            midline = td.LineSegment(end1, end2),
            tolerance = 1
        )
    ...
    def test_from_diagonal1(self):
        ...
        end1 = td.Point(0, 0)
        end2 = td.Point(1, 1)
        instance1 = td.Rectangle.from_diagonal(
            diagonal = td.LineSegment(end1, end2)
        )
        vertex1 = td.Point(0, 0)
    ...
    def test_midlines(self):
        ...
        instance = td.Rectangle(vertex1, vertex2, vertex3, vertex4)
        midline1 = td.LineSegment(
            end1 = td.Point(0.5, 0),
            end2 = td.Point(0.5, 2)
        )
        midline2 = td.LineSegment(
            end1 = td.Point(0, 1),
            end2 = td.Point(1, 1)
        )
    ...
    def test_diagonals(self):
        ...
        vertex4 = td.Point(0, 1)
        instance = td.Rectangle(vertex1, vertex2, vertex3, vertex4)
        diagonal1 = td.LineSegment(
            end1 = td.Point(0, 0),
            end2 = td.Point(1, 1)
        )
        diagonal2 = td.LineSegment(
            end1 = td.Point(1, 0),
            end2 = td.Point(0, 1)
        )
